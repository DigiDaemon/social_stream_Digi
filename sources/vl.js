(function () {
	...
	setInterval(function(){
		try {
		if (document.querySelector('vs_chatv9_msg')){
			if (!document.querySelector('vs_chatv9_msg').marked){
				document.querySelector('vs_chatv9_msg').marked=true;
				console.log("CONNECTED chat detected");
        
				setTimeout(function(){
					document.querySelectorAll("vs_chatv9_msg li").forEach(ele=>{
						ele.skip=true;
						// processMessage(ele);
					});
					onElementInserted('vs_chatv9_msg');
				},1000);
			}
		}} catch(e){}
	},2000);
